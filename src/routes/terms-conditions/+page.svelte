...
<Layout pageTitle="Terms & Conditions">
	<h2 class="text-5xl font-bold">Terms and Conditions</h2>
	<div class="divider" />
	<div class="space-y-2">
		...
		<ul class="list-disc pl-6">
			...
			<li>
				<p>
					...
					<a href="http://www.mmwpcb.com" rel="external nofollow noopener" target="_blank">http://www.mmwpcb.com</a>
				</p>
			</li>
			<li>
				<p>
		...
		<h2 class="text-3xl font-bold">Acknowledgment</h2>
		<p>
		...
		<h2 class="text-3xl font-bold">Termination</h2>
		<p>
		...
		<h2 class="text-3xl font-bold">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
		<p>
		...
		<h2 class="text-3xl font-bold">For European Union (EU) Users</h2>
		<p>
		...
		<h2 class="text-3xl font-bold">United States Legal Compliance</h2>
		<p>
		...
		<h2 class="text-3xl font-bold">Severability and Waiver</h2>
		<h3 class="text-xl font-bold">Severability</h3>
		<p>
		...
		<h3 class="text-xl font-bold">Waiver</h3>
		<p>
		...
		<h2 class="text-3xl font-bold">Translation Interpretation</h2>
		<p>
		...
		<h2 class="text-3xl font-bold">Changes to These Terms and Conditions</h2>
		<p>
