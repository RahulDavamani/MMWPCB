...
<Layout pageTitle="Refund Policy">
	...
	<div class="space-y-2">
		...
		<p>Thank you for shopping at MMWPCB.</p>
		<p>
			If, for any reason, You are not completely satisfied with a purchase We invite You to review our policy on refunds
			and returns. This Return and Refund Policy has been created with the help of the <a
				href="https://www.freeprivacypolicy.com/free-return-refund-policy-generator/"
				target="_blank">Free Return and Refund Policy Generator</a
			>.
		</p>
		<p>The following terms are applicable for any products that You purchased with Us.</p>
		<h2 class="text-3xl font-bold">Interpretation and Definitions</h2>
		...
		<ul class="list-disc pl-6">
			<li>
				<p>
					...
					in this Agreement) refers to Velenova, Unit 518A, 5/F, InnoCentre, 72 Tat Chee Avenue, Kowloon Tong, Kowloon, Hong
					Kong..
				</p>
			</li>
			<li>
			...
			<li>
				<p>
					<strong>Website</strong> refers to MMWPCB, accessible from
					<a href="https://www.mmwpcb.com" rel="external nofollow noopener" target="_blank">https://www.mmwpcb.com</a>
				</p>
			</li>
			<li>
				<p>
		...
		<h2 class="text-3xl font-bold">Your Order Cancellation Rights</h2>
		<p>You are entitled to cancel Your Order within 7 days without giving any reason for doing so.</p>
		<p>
			The deadline for cancelling an Order is 7 days from the date on which You received the Goods or on which a third
		...
		<h2 class="text-3xl font-bold">Conditions for Returns</h2>
		...
		<h2 class="text-3xl font-bold">Returning Goods</h2>
		<p>
			You are responsible for the cost and risk of returning the Goods to Us. You should send the Goods at the following
			address:
		</p>
		<p>Unit 518A, 5/F, InnoCentre, 72 Tat Chee Avenue, Kowloon Tong, Kowloon, Hong Kong.</p>
		<p>
		...
		<h2 class="text-3xl font-bold">Gifts</h2>
		<p>
			If the Goods were marked as a gift when purchased and then shipped directly to you, You'll receive a gift credit
