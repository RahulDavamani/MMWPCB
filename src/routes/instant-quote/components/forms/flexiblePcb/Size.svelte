<script lang="ts">
	...
	$: l = $lg.instantQuote.flexiblePcb;

	$: ({ length, width } = $quote.products.flexiblePcb);
	$: size = (length * width) / 1000000;

	$: lengthError = $quoteError.flexiblePcb.length;
	$: widthError = $quoteError.flexiblePcb.width;
			...
			<div class="flex">
				<label class="input input-bordered input-sm {lengthError && 'input-error'} flex items-center gap-2">
					<input
						...
						bind:value={$quote.products.flexiblePcb.length}
					/>
				...
				<div class="flex items-center gap-2">
					...
					<label class="input input-bordered input-sm {widthError && 'input-error'} flex items-center gap-2">
						<input
							...
							bind:value={$quote.products.flexiblePcb.width}
						/>
						<span class="opacity-75">mm</span>
					</label>
				</div>
					...
					<div class="flex items-center gap-2">
						<label class="input input-bordered input-sm flex items-center gap-2">
							<input
								...
								on:change={(e) => ($quote.products.flexiblePcb.length = Number(e.currentTarget.value) / 0.1)}
							/>
						...
						<label class="input input-bordered input-sm flex items-center gap-2">
							<input
								...
								on:change={(e) => ($quote.products.flexiblePcb.width = Number(e.currentTarget.value) / 0.1)}
							/>
							<span class="opacity-75">inch</span>
						</label>
					</div>
					...
					<div class="flex items-center gap-2">
						<label class="input input-bordered input-sm flex items-center gap-2">
							<input
								...
								on:change={(e) => ($quote.products.flexiblePcb.length = Number(e.currentTarget.value) / 0.001)}
							/>
							<span class="opacity-75">inch</span>
						</label>
						<Icon icon="mdi:multiply" />
						<label class="input input-bordered input-sm flex items-center gap-2">
							<input
								...
								on:change={(e) => ($quote.products.flexiblePcb.width = Number(e.currentTarget.value) / 0.001)}
							/>
							<span class="opacity-75">inch</span>
						</label>
					</div>
