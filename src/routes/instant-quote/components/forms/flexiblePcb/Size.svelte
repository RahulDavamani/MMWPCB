				...
				<div class="flex items-center gap-2">
					<label class="input input-bordered input-sm flex items-center gap-2">
						<input
							...
							on:change={(e) => ($quote.products.flexiblePcb.length = Number(e.currentTarget.value) / 0.03937)}
						/>
					...
					<label class="input input-bordered input-sm flex items-center gap-2">
						<input
							...
							on:change={(e) => ($quote.products.flexiblePcb.width = Number(e.currentTarget.value) / 0.03937)}
						/>
						<span class="opacity-75">inch</span>
					</label>
				</div>
