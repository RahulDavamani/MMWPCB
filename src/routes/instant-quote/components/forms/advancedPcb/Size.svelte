<script lang="ts">
	...
	$: l = $lg.instantQuote.advancedPcb;

	$: ({ length, width } = $quote.products.advancedPcb);
	$: size = (length * width) / 1000000;

	$: lengthError = $quoteError.advancedPcb.length;
	$: widthError = $quoteError.advancedPcb.width;
			...
			<div class="flex">
				<label class="input input-bordered input-sm {lengthError && 'input-error'} flex items-center gap-2">
					<input
						...
						bind:value={$quote.products.advancedPcb.length}
					/>
				...
				<div class="flex items-center gap-2">
					...
					<label class="input input-bordered input-sm {widthError && 'input-error'} flex items-center gap-2">
						<input
							...
							bind:value={$quote.products.advancedPcb.width}
						/>
						<span class="opacity-75">mm</span>
					</label>
				</div>
					...
					<div class="flex items-center gap-2">
						<label class="input input-bordered input-sm flex items-center gap-2">
							<input
								...
								on:change={(e) => ($quote.products.advancedPcb.length = Number(e.currentTarget.value) / 0.1)}
							/>
						...
						<label class="input input-bordered input-sm flex items-center gap-2">
							<input
								...
								on:change={(e) => ($quote.products.advancedPcb.width = Number(e.currentTarget.value) / 0.1)}
							/>
							<span class="opacity-75">inch</span>
						</label>
					</div>
					...
					<div class="flex items-center gap-2">
						<label class="input input-bordered input-sm flex items-center gap-2">
							<input
								...
								on:change={(e) => ($quote.products.advancedPcb.length = Number(e.currentTarget.value) / 0.001)}
							/>
							<span class="opacity-75">inch</span>
						</label>
						<Icon icon="mdi:multiply" />
						<label class="input input-bordered input-sm flex items-center gap-2">
							<input
								...
								on:change={(e) => ($quote.products.advancedPcb.width = Number(e.currentTarget.value) / 0.001)}
							/>
							<span class="opacity-75">inch</span>
						</label>
					</div>
